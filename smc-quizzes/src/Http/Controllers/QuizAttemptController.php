...
use Quiz\Api\Http\Resources\QuizAttemptResource as ResourceClass;
use Quiz\Api\Models\Quiz as ResourceParentModalClass;
use Quiz\Api\Models\QuizAttempt as ResourceModalClass;

class QuizAttemptController extends BaseApiController
{
    /**
