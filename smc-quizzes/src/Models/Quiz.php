...
use Quiz\Api\Database\Factories\QuizFactory;
...
class Quiz extends Model
{
    ...
    {
        return config('smc-quizzes.table_names.quizzes');
    }
    ...
    {
        return $this->hasMany(config('smc-quizzes.models.quiz_attempt'));
    }
    ...
    {
        return $this->hasMany(config('smc-quizzes.models.quiz_author'));
    }
