...
use Training\Api\Http\Resources\CourseResource as ResourceClass;
use Training\Api\Models\Course as ResourceModalClass;

class UserCourseController extends BaseApiController
{
    /**
    ...
    public function create(Request $request){
        return view('smc-training.pages.forms.courses.create');
    }
