<!doctype html>
<html lang="en" ng-app="smcPortalERPApp">
<head>
    <!-- Required meta tags -->
    <meta charset="utf-8">
...
<script>
    ...
    /** Primary App Module */
    app = angular.module('smcPortalERPApp', [
        //..
        //'ngRoute'
        'ui.router'
    ]);
                ...
                controller: (function ($scope, $timeout, $http, smcAppService){
                    ...
                    $scope.viewboxTableData = {
                        data : {
                            ...
                            itemData : {},
                            theadContent: '<thead><tr><th scope="col" style="min-width: 120px">#</th><th scope="col" style="min-width: 150px">Email</th><th scope="col" style="min-width: 200px">Url</th><th scope="col" style="min-width: 200px">Description</th><th scope="col" style="min-width: 200px">Options</th><th scope="col" style="min-width: 150px" class="text-center">Actions</th></tr></thead>',
                            tbodyContent : '<tbody><tr ng-repeat=" item in Ctrl.data.data.itemData.data"><th scope="row" ng-bind="item.id"></th><td ng-bind="item.email"></td><td><a target="_blank" ng-href="<%item.url ? item.url : \'/\'%>">Order Form Link</a></td><td class="text-truncate" ng-bind="item.description"></td><td><span class="badge bg-danger text-white" ng-if="item.has_footer_html == true">FOOTER HTML</span><span class="badge bg-danger text-white" ng-if="item.has_header_html == true">HEADER HTML</span></td><td class="text-end"><!-- drop-button --><div class="btn-group dropstart"><button type="button" class="btn btn-secondary btn-sm dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">Actions</button><ul class="dropdown-menu"><!-- Dropdown menu links --><li><a class="dropdown-item" href="#">Edit</a></li><li><a class="dropdown-item" href="#">View</a></li><li><a class="dropdown-item" href="#">Delete</a></li></ul></div></td></tr></tbody>',
