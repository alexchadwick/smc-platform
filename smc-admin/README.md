...
**With this package you can easily setup admin functionality into your Laravel project.**
...
```bash
composer require smc-dev/smc-admin
```
...
```bash
php artisan vendor:publish --provider="Admin\AdminServiceProvider"
```
