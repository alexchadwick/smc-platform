...
use Quiz\Api\Database\Factories\QuestionTypeFactory;
...
class QuestionType extends Model
{
    ...
    {
        return config('smc-quizzes.table_names.question_types');
    }
    ...
    {
        return $this->hasMany(config('smc-quizzes.models.question'));
    }
